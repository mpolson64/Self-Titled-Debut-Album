...
function genre() {
    var genres = ['acoustic', 'alternative', 'blues', 'country', 'electronic', 'hip-hop', 'neojazz', 'metal', 'pop', 'rock', 'rap', 'classical', 'folk', 'dubstep', 'crossoverthrash', 'grunge', 'nuwave', 'ChristianRock', 'gospel', 'adultcontemporary', 'neosoul', 'TexMex', 'dadrock', "rocknroll", 'altrock', 'electronica', 'JPop', 'RnB', 'synthpop', 'vaporwave', 'experimental', 'trap', 'AtlantaRap', 'cloudrap', 'deephouse', 'house', 'futurefunk', 'electrofunk', 'funk', 'chillwave', 'EDM', 'IDM', 'nightcore', 'disco', 'gangstarap', 'drill', 'oldskool #hiphop', 'eurobeat', 'dreampop', 'psychrock', 'psychpop', 'shoegaze', 'numetal', 'blackmetal', 'dancepop'];
